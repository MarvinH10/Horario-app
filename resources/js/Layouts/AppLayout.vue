                ...
                <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between h-16">
                            <div class="flex">
                                <button class="rounded-md text-gray-600" @click="toggleSidebar">
                                    <ion-icon v-if="!isSidebarOpen"
                                        style="color: rgb(156 163 175 / var(--tw-text-opacity, 1));"
                                        name="lock-closed-outline" class="w-6 h-6"></ion-icon>
                                    <ion-icon v-else style="color: rgb(156 163 175 / var(--tw-text-opacity, 1));"
                                        name="lock-open-outline" class="w-6 h-6"></ion-icon>
                                </button>
                            </div>
